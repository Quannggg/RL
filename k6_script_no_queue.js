...
// Scenario: Test /orders-no-queue endpoint WITHOUT queue (GKI - Không có Queue)
...
export default function () {
  const targetUrl = 'http://localhost:3000/demo/orders-no-queue';
  ...
  check(res, {
    ...
    'status 429 (Too Many Requests - Rejected)': (r) => r.status === 429,
  });
}
